...
export const slidevKnowledge = {
    overview: {
      description: "Slidev is a web-based slides maker designed for developers. It uses Markdown with Vue.js components for pixel-perfect, interactive presentations.",
      website: "https://sli.dev/guide/",
      syntax: "Markdown with frontmatter configuration and special directives"
    },
  
    themes: [
      "default", "apple-basic", "bricks", "brutalist", "academic", "border",
      "carbon", "chalkboard", "cover", "dracula", "eloc", "geist", "glass",
      "landing", "light-icons", "materia", "minimal", "none", "orange",
      "penguin", "purplin", "seriph", "shibainu", "simple", "sky", "space",
      "teeth", "theme-academic", "unicorn", "vitesse", "waves"
    ],
    ...
    layouts: [
      "center", "cover", "default", "end", "fact", "full", "image", "image-left",
      "image-right", "intro", "none", "quote", "section", "statement", "two-cols",
      "two-cols-header", "iframe", "iframe-left", "iframe-right"
    ],
  ...
  export const generateSlidevGuidance = (presentationType = "technical") => {
    const structure = slidevKnowledge.exampleStructures[presentationType] ||
                     slidevKnowledge.exampleStructures.technical;
  
    return {
      recommendedThemes: presentationType === "business"
